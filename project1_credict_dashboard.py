...
with tab2:
    ...
    #建篩選器
    input_id = int(st.selectbox("選擇查詢客戶ID", set(application_new['ID'])))
    filter_df = application_new[application_new['ID'] == input_id]
    #print(filter_df)
    ...
    record_new2 = record_new2[['ID', '本月', '前1月', '前2月', '前3月', '前4月', '前5月', '前6月', '前7月', '前8月', '前9月', '前10月', '前11月', '前12月', '前13月', '前14月', '前15月', '前16月', '前17月', '前18月', '前19月', '前20月', '前21月', '前22月', '前23月', '前24月', '前25月', '前26月', '前27月', '前28月', '前29月', '前30月', '前31月', '前32月', '前33月', '前34月', '前35月', '前36月', '前37月', '前38月', '前39月', '前40月', '前41月', '前42月', '前43月', '前44月', '前45月', '前46月', '前47月', '前48月', '前49月', '前50月', '前51月', '前52月', '前53月', '前54月', '前55月', '前56月', '前57月', '前58月', '前59月', '前60月']]
    st.write('###### Repayment Records') 
    st.dataframe(record_new2[record_new2['ID'] == input_id])
